...
fig = px.bar(everyone, x='jour', y='P', title='Regional SI-DEP Positive COVID-19 Tests as of %s' % date, template='ggplot2', color='reg', color_discrete_sequence=px.colors.qualitative.Dark24)
...
everyone = data[data['cl_age90'] == 0]
date = everyone.tail(1)['jour'].array[0]
fig = px.bar(everyone, x='jour', y='P', title='France SI-DEP Positive COVID-19 Tests as of %s' % date, template='ggplot2')
